package com.iteso.msc_testsession8.tools;
...
public class NothingSelectedSpinnerAdapter implements SpinnerAdapter,
	...
	public final View getView(int position, View convertView, ViewGroup parent) {
		// This provides the View for the Selected Item in the Spinner, not the
		// dropdown (unless dropdownView not set)
		if (position == 0) {
	...
	/**
	 * Override this to do something dynamic... e.g.
	 * "Pick your Favorite of these 37"
	 * 
	 * @param parent
	 * @return
	 */
